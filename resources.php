...
<meta name="keywords" content="holly, fitzgerald, meditation, relaxation, depression, resources, anxiety, therapy, chapel hill, nc, orange county, carrboro" />
<meta name="description" content="Holly FitzGerald has close to twenty years experience as a  Clinical Social Worker in Chapel Hill, and worked with various social service agencies since 1971. A specialist in the areas of depression, anxiety, Holly is consistently work with" />

<title>Chapel Hill Therapy: Additional Resources including Depression, Anxiety, Addictions | Holly FitzGerald, LCSW, Chapel Hill, NC 27514</title>
...
<body id="resources"><?php include("mainnav.php") ?>
 ...
 <div id="textmain">
  ...
  <p>Information is wonderful, but sometimes it can be overwhelming.  In an effort to make the search a little easier, I have provided links to valuable resources related to many common mental health issues including depression, anxiety, post-traumatic stress, addictions, and more.  Feel free to take down any questions or comments about the information provided in the links below to bring to our introductory session.
   ...
   <h2>Addictions</h2>
    <ul>
     <li><a href="http://www.well.com/~woa/">The Web of Addictions</a></li>
     <li><a href="http://www.addictions.co.uk/">Thoughts from the UK on Addictions</a></li>
     <li><a href="http://www.habitsmart.com/">Smart Habits</a></li>
     <li><a href="http://www.selfhelpmagazine.com/articles/atd/stagesrecovery.html">Recovering from Addiction</a></li>
    </ul>
   <h2>Family and Couple</h2>
    <ul>
     <li><a href="http://www.psychologyinfo.com/problems/family.html">Family Problems</a></li>
     <li><a href="http://www.aap.org/pubed/ZZZJOXAF79C.htm?&sub_cat=106">Communication</a></li>
     <li><a href="http://marriage.about.com/cs/advice/a/marcounsel.htm">Troubled Marriages</a></li>
     <li><a href="http://www.marriageadvice.com/">Marriage Advice</a></li>
    </ul>
   <h2>Aging</h2>
    <ul>
     <li><a href="http://www.thehappyguy.com/aging-gracefully.html">Aging Gracefully</a></li>
     <li><a href="http://www.pioneerthinking.com/lmc-aging.html">Aging Tips</a></li>
